...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String urlProfileImg = "http://www.opensourcetutorials.in/wp-content/uploads/2016/10/logo-300x300.jpg";
    ...
    private static final String TAG_OPENSOURCE = "opensource";
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("OpenSourceTutorials");
        txtWebsite.setText("www.opensourcetutorials.in");
